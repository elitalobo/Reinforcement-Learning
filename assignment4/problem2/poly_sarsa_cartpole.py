...
if __name__=="__main__":
	...
	for order in orders:
		...
		for alpha in alphas:
			...
			plot_error(trial_rewards,[i for i in range(0,len(trial_rewards))],"episodes","rewards","rewards vs episodes","sarsa_poly_cartpole_rewards_" + str(cartpole.order) + "_"+ str(cartpole.alpha)+".png",std_dev)

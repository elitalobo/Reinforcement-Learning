...
if __name__=="__main__":
	...
	for values in  gridsearch:
		...
		print trial_rewards
		plot_error(trial_rewards,[i for i in range(0,len(trial_rewards))],"episodes","rewards","rewards vs episodes","cartpole/final_sarsa_cartpole_rewards_" + str(cartpole.order) + "_"+ str(cartpole.alpha)+ "_" + str(cartpole.epsilon)+".png",std_dev)	

...
if __name__=="__main__":
	...
	for values in  gridsearch:
		filet = "cartpole_qlearn_results_"+str(values[0])+"_"+str(values[1])+"_"
		total_rewards=[]
		trial_cnt=0
		while trial_cnt < trials:
		...
		print trial_rewards
		plot_error(trial_rewards,[i for i in range(0,len(trial_rewards))],"episodes","rewards","rewards vs episodes","softmax_qlearn_cartpole_rewards_" + str(cartpole.order) + "_"+ str(cartpole.alpha)+ "_" + str(cartpole.epsilon)+".png",std_dev)	
